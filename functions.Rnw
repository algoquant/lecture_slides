...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The enclosure of functions defined in packages is the package \emph{namesvpace}.
      \vskip1ex
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The function \texttt{methods()} listv all the \emph{methods} of a generic function, or all the \emph{methods} for a \emph{class} of objects.
      \vskip1ex
