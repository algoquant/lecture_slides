...
\begin{block}{}
  \begin{columns}[T]
    \column{0.4\textwidth}
      ...
      \vskip1ex
      The function body doesn't require a return statement, since by default \texttt{R} functions return the last statement evaluated in the body,
      \vskip1ex
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.4\textwidth}
      ...
      \vskip1ex
      When a function is applied, it's passed a list of actual function arguments,
      \vskip1ex
