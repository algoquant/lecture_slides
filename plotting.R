...
axis(side=4, col="red")
# Add axis labels
colnames <- colnames(zoo_stxeur)
mtext(colnames[1], side=2, adj=-0.5)
mtext(colnames[2], side=4, adj=1.5, col="red")
# Add title and legend
title(main=paste0(colnames, collapse=" and "),
line=0.5)
legend("top", legend=colnames,
