...
######
# assign the names: "el1, ..., el10", to the vector elements, using the function paste(),
# with the proper "sep" argument, (you can't use function c())
...
##################################
# 3. (10pts) create a numeric vector of length 30 containing random normal variates, using rnorm(),
