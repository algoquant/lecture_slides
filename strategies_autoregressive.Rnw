...
%%%%%%%%%%%%%%%
\subsection{AR Strategy With Forecasts Scaled By Volatility}
\begin{frame}[fragile,t]{\subsecname}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
...
%%%%%%%%%%%%%%%
\subsection{Optimization of the Autoregressive Coefficients}
\begin{frame}[fragile,t]{\subsecname}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      The autoregressive strategy invests dollar amounts of \emph{VTI} proportional to the AR forecasts.
      \vskip1ex
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      The autoregressive strategy with aggregated stock returns calculates the \emph{AR} coefficients and the forecasts using stock returns aggregated over several days.
      \vskip1ex
...
%%%%%%%%%%%%%%%
\subsection{Autoregressive Coefficients With Ridge Shrinkage}
\begin{frame}[fragile,t]{\subsecname}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      The out-of-sample performance of the multifactor autoregressive strategy can be improved by applying \emph{shrinkage} to the \emph{AR} coefficients.
      \vskip1ex
