...
curve(expr=df(x, df1=deg_free[in_dex], df2=3),
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/f_dist.png}
      \vspace{-1em}
        <<echo=TRUE,eval=FALSE>>=
# Add title
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.4\paperwidth]{figure/reg_svd.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
...
for (in_dex in 1:3) {
  curve(expr=plogis(x, scale=lamb_da[in_dex]),
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/logistic_func.png}
      \vspace{-2em}
        <<echo=TRUE,eval=FALSE>>=
# Add title
...
summary(g_lm)
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/islr_logistic_reg.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
x11(width=6, height=5)
...
summary(g_lm)
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/islr_logistic_count.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
