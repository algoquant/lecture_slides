...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The family object \texttt{binomial(logit)} specifies a binomial distribution of residuals.
      <<echo=(-(1:1)),eval=FALSE>>=
set.seed(1121)
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The \texttt{default} and \texttt{student} columns can be converted to \texttt{Boolean} values, with \texttt{TRUE} if \texttt{default == "No"} and \texttt{student == "No"}, and \texttt{FALSE} otherwise.
    \column{0.5\textwidth}
      <<echo=TRUE,eval=TRUE>>=
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The family object \texttt{binomial(logit)} specifies a binomial distribution of residuals in the \emph{logistic} regression model.
      <<echo=TRUE,eval=FALSE>>=
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      Let the \emph{null hypothesis} be that the subject will not default: \texttt{not\_default = TRUE}.
      \vskip1ex
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The \emph{null hypothesis} is that \texttt{not\_default = TRUE}.
      \vskip1ex
