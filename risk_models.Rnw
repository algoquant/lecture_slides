  ...
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \begin{flalign*}
        ...
        & \operatorname{cov}_t = \lambda \operatorname{cov}_{t-1} + (1-\lambda) (p_t - \bar{p}_t)^T (X_t - \bar{X}_t) \\
      ...
      $\operatorname{cov}_t$ is the covariance matrix between the response and the predictor data, 
