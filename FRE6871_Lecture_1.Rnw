...
The graduate assistant (GA) will be Preyansh Agrawal \href{mailto:pa2753@nyu.edu}{pa2753@nyu.edu}.\\
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      \emph{AI} systems don't always produce fast \texttt{R} code, so it's important to know how to write fast \texttt{R} code yourself.
      \vskip1ex
...
\begin{block}{Recommended}
  \begin{itemize}[]
    ...
    \item Read about plotting from \emph{plot\_par\_cheatsheet.pdf} and \emph{ggplot2\_cheatsheet.pdf}.
    \item Study the 
