...
The graduate assistant (GA) will be Yimeng Ma \href{mailto:ym1685@nyu.edu}{ym1685@nyu.edu}.\\
...
\begin{itemize}[]
  \item There will be no required textbook, but a recommended textbook is 
  \href{http://it-ebooks.info/book/1734/}{\emph{The Art of \texttt{R} Programming}} by Norman Matloff, which contains a good introduction to \texttt{R} and to statistical models.
