...
\subtitle{Lecture\#1, Spring 2024}
...
Students will be allowed to copy code from the lecture slides, and to copy from books or any online sources, but they will be required to provide references to those external sources (such as links or titles and page numbers).
      \vskip1ex
Students are encouraged to use \href{https://copilot.github.com/}{\emph{GitHub Copilot}} for \href{https://docs.posit.co/ide/user/ide/guide/tools/copilot.html}{\emph{RStudio}}.
      \vskip1ex
...
The graduate assistant (GA) will be Shubham Singh \href{mailto:shubham.singh@nyu.edu}{shubham.singh@nyu.edu}.\\
