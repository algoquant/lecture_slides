...
eq_all <- exp(cumsum(sig_nals*re_turns))
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/rsi_indic.png}
      \vspace{-2em}
      <<echo=TRUE,eval=FALSE>>=
...
colnames(re_turns) <- paste0("lambda=", lamb_das)
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/ewma_returns.png}
      \vspace{-2em}
      <<echo=TRUE,eval=FALSE>>=
...
pnl_s <- xts(pnl_s, order.by=index(fwd_rets))
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/backtest_ewma.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
...
zoo::plot.zoo(weight_s, xlab=NULL, main="Momentum Portfolio Weights")
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/momentum_weights.png}
  \end{columns}
\end{block}
...
plot.zoo(cbind(beta_s, 
  ...
  main="betas & VTI", xlab="")
    ...
    \column{0.5\textwidth}
    \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/momentum_betas.png}
  \end{columns}
\end{block}
...
colnames(pnl_s) <- c("VTI", "momentum")
    ...
    \column{0.5\textwidth}
    \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/momentum_backtest.png}
      \vspace{-2em}
      <<echo=TRUE,eval=FALSE>>=
...
cor(na.omit(diff(log(pnl_s))))
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth,valign=t]{figure/momentum_combined.png}
      \vspace{-2em}
      <<echo=TRUE,eval=FALSE>>=
