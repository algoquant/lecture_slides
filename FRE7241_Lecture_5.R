...
load(file="C:/Develop/data/etf_data.Rdata")
library(quantmod)  # load package "quantmod"
ls(data_env)  # list files in data_env
# get class of object in data_env
class(get(x=sym_bols[1], envir=data_env))
# another way
class(data_env$VTI)
...
## data_env$VTI <- adjustOHLC(data_env$VTI,
##                      use.Adjusted=TRUE)
## 
## # adjust OHLC object using string as name
## assign(sym_bols[1], adjustOHLC(
##     get(x=sym_bols[1], envir=data_env),
##     use.Adjusted=TRUE),
##   envir=data_env)
## 
...
##   assign(sym_bol,
##    adjustOHLC(get(sym_bol, envir=data_env),
##               use.Adjusted=TRUE),
##    envir=data_env)
## }
## load(file="C:/Develop/data/etf_data.Rdata")
...
## save(data_env, etf_series, etf_series_ad,
##      file='etf_data.Rdata')
library(quantmod)
load(file="C:/Develop/data/etf_data.Rdata")
# scrub NA values
...
## chartSeries(data_env$VTI["2014-11"],
##       name="VTI",
