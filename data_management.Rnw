...
# Download SPY prices in JSON format from Polygon
download.file(ur_l, "/Users/jerzy/Data/data.json")
# Read SPY prices from json file
oh_lc <- jsonlite::read_json("/Users/jerzy/Data/data.json")
class(oh_lc)
NROW(oh_lc)
names(oh_lc)
...
save(oh_lc, file="/Users/jerzy/Data/spy_daily.RData")
