...
data.table::fwrite(tickb, file="/Users/jerzy/Develop/data/xlk_tick_trades2020_0316_biglots.csv")
...
dir_name <- "/Users/jerzy/Develop/data/ib_data"
dir.create(dir_name)
file_name <- file.path(dir_name, paste0(symboln, "201906.csv"))
...
file_name <- file.path(dir_name, paste0(symboln, "M8.csv"))
file_connect <- file(file_name, open="w")
# Connect to Interactive Brokers TWS
ib_connect <- IBrokers::twsConnect(port=7497)
# Download historical data to file
...
dir_name <- "/Users/jerzy/Develop/data/ib_data"
dir.create(dir_name)
file_name <- file.path(dir_name, paste0(symboln, ".csv"))
file_connect <- file(file_name, open="w")
# Connect to Interactive Brokers TWS
ib_connect <- IBrokers::twsConnect(port=7497)
# Download historical data to file
...
dir_name <- "/Users/jerzy/Develop/data/ib_data"
# Dir.create(dir_name)
file_name <- file.path(dir_name, paste0(symboln, "_taq_live.csv"))
file_connect <- file(file_name, open="w")
# Connect to Interactive Brokers TWS
ib_connect <- IBrokers::twsConnect(port=7497)
...
dir_name <- "/Users/jerzy/Develop/data/ib_data"
# Dir.create(dir_name)
file_name <- file.path(dir_name, paste0(symboln, "_ohlc_live.csv"))
file_connect <- file(file_name, open="w")
# Connect to Interactive Brokers TWS
ib_connect <- IBrokers::twsConnect(port=7497)
# Download live data to file
