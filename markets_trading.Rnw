...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The \emph{SEC} filings are publicly available online through the \href{https://www.sec.gov/edgar.shtml}{\emph{EDGAR}} database, and they are compiled into premium (license fee) databases by vendors such as \href{http://www.compustat.com/}{\emph{Compustat}} and \href{http://www.factset.com/}{\emph{FactSet}}.
      \vskip1ex
      ...
      \vskip1ex
      Data from the \emph{10Q}, \emph{10K}, and other \emph{SEC} filings are compiled by vendors such as \href{http://www.compustat.com/}{\emph{Compustat}} and \href{http://www.factset.com/}{\emph{FactSet}}, into premium databases.
      \vskip1ex
    ...
    \column{0.5\textwidth}
      ...
      \href{https://www.quandl.com/data/RAYMOND-Raymond}{\emph{RAYMOND}} database on \href{https://www.quandl.com/}{\emph{Quandl}}.
      \vskip1ex
      \href{https://www.quandl.com/data/RAYMOND-Raymond}{\emph{RAYMOND}} is a free \href{https://www.quandl.com/}{\emph{Quandl}} database of harmonized stock fundamentals, based on the \emph{SEC} database, but it has several limitations.
      \vskip1ex
      The report harmonization procedure fails when companies change their accounting treatment from year to year.
      \vskip1ex
      The data only goes back to $2009$, because the \emph{SEC} did not mandate electronic filing before then.
      \vskip1ex
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_home.pdf}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_classroom.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_manuals.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_browse_data.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_compustat.png}\\
      \includegraphics[width=0.5\paperwidth]{figure/wrds_compustat_north_america.png}
  \end{columns}
\end{block}
...
names_table <- read.csv(file="C:/Develop/lecture_slides/data/compustat_table.csv", stringsAsFactors=FALSE)
# sym_bol <- "VTI"
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_index_constituents.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_compustat_fundamental.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_saved_queries.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_crsp.png}
  \end{columns}
\end{block}
...
oh_lc <- read.csv(file="C:/Develop/lecture_slides/data/F_CRSP.csv", 
  stringsAsFactors=FALSE, colClasses=col_class)
...
plot(quantmod::Cl(oh_lc), main="Ford Stock")
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_crsp_prices.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_crsp_compustat.png}
      \vspace{-1em}
      <<echo=FALSE,eval=FALSE,results='asis'>>=
crsp_compustat <- read.csv(file="C:/Develop/lecture_slides/data/crsp_compustat_indices.csv", stringsAsFactors=FALSE)
...
plot(quantmod::Cl(oh_lc), main="TAP Stock")
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_compustat_prices.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/wrds_taq_data.png}
  \end{columns}
\end{block}
...
%%%%%%%%%%%%%%%
\subsection{Coercing \protect\emph{TAQ} Data to \texttt{xts} Time Series}
\begin{frame}[fragile,t]{\subsecname}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
...
dygraphs::dygraph(x_ts[, 1], 
  main="XLK Trade Ticks for 2020-03-16")
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.5\paperwidth]{figure/hf_trade_ticks_dygraph.png}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/hf_stocks_bounce.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      Most of the \emph{trade} ticks are \emph{odd lots} with a small volume of less than $100$ shares.
      \vskip1ex
...
colnames(x_ts) <- c("XLK.Close", "XLK.Volume")
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.5\paperwidth]{figure/hf_trade_ticks_biglots_dygraph.png}
      \vspace{-2em}
      <<echo=TRUE,eval=FALSE>>=
# Plot the large lots
x11(width=6, height=4)
