...
vec1 %*% vec2
    ...
    \column{0.5\textwidth}
      ...
      \begin{lstlisting}[language=R,basicstyle=\tiny\ttfamily\bfseries,backgroundcolor=\color{anti_flashwhite},showstringspaces=FALSE]
// Rcpp header with information for C++ compiler
#include <\emph{RcppArmadillo}.h>
using namespace Rcpp;
using namespace arma;
// [[Rcpp::depends(\emph{RcppArmadillo})]]
...
summary(microbenchmark(
  ...
  times=100))[, c(1, 4, 5)]  # end microbenchmark summary
    ...
    \column{0.5\textwidth}
      ...
      \begin{lstlisting}[language=R,basicstyle=\tiny\ttfamily\bfseries,backgroundcolor=\color{anti_flashwhite},showstringspaces=FALSE]
// Rcpp header with information for C++ compiler
#include <\emph{RcppArmadillo}.h> // include C++ header file from Armadillo library
using namespace arma; // use C++ namesvpace from Armadillo library
// declare dependency on \emph{RcppArmadillo}
// [[Rcpp::depends(\emph{RcppArmadillo})]]
...
// Rcpp header with information for C++ compiler
// [[Rcpp::depends(\emph{RcppArmadillo})]]
#include <\emph{RcppArmadillo}.h>  // include Rcpp C++ header files
using namespace std;
using namespace Rcpp; // use Rcpp C++ namesvpace
using namespace arma;
