...
legend("top", legend=colnamev, cex=1.0, bg="white",
      ...
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.4\paperwidth, height=0.35\paperwidth]{figure/zoo2yaxis.png}
  \end{columns}
\end{block}
...
dygraphs::dygraph(prices, main=paste(colnamev, collapse=" and ")) %>%
  ...
  dySeries(name=colnamev[2], axis="y2", strokeWidth=2, col="blue")
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.4\paperwidth, height=0.35\paperwidth]{figure/dygraphs2yaxis.png}
  \end{columns}
\end{block}
...
for (indeks in 1:NROW(sigmavs)) {
  curve(expr=dlnorm(x, sdlog=sigmavs[indeks]),
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.4\paperwidth]{figure/lognormv_dist.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
# Add title and legend
...
sqrt(nrows)*sigmav
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.4\paperwidth]{figure/lognormv_skew.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
...
\begin{block}{}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.4\paperwidth]{figure/lognormv_prob.png}
      \vspace{-1em}
      <<echo=TRUE,eval=FALSE>>=
