...
LC_CTYPE=C && LANG=C && sed -i '' 's/date time/datev/g' *.R*
...
LC_CTYPE=C && LANG=C && sed -i '' 's/fit_ted/fittedv/g' *.R*
...
LC_CTYPE=C && LANG=C && sed -i '' 's/resid_uals/residv/g' *.R*
LC_CTYPE=C && LANG=C && sed -i '' 's/residual_s/residv/g' *.R*
