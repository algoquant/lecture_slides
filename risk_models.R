...
# quantmod::chart_Series(pricev["2008/2009"], theme=themev,
...
# themev <- chart_theme()
# themev$col$line.col <- c("black", "red")
# quantmod::chart_Series(stdev["2011-07/2011-12"],
#   theme=themev, name="Standard Deviations: Close and YZ")
...
#   theme=themev, name="Volatility Around 2010 Flash Crash")
# legend("top", legend=colnames(stdev), y.intersp=0.4,
#  bg="white", lty=1, lwd=6, inset=0.1, cex=0.8,
#  col=themev$col$line.col, bty="n")
...
# # Plot wealth paths
# themev <- chart_theme()
# themev$col$line.col <- c("black", "orange", "blue")
# quantmod::chart_Series(kelly_paths, theme=themev, name="Wealth Paths")
...
# themev <- chart_theme()
# themev$col$line.col <- c("black", "orange", "blue")
# quantmod::chart_Series(kelly_paths, theme=themev,
#        name="Wealth Paths")
# legend("topleft", legend=colnames(kelly_paths),
#  inset=0.1, bg="white", lty=1, lwd=6, y.intersp=0.5,
#  col=themev$col$line.col, bty="n")
