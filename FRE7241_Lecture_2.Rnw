...
\subtitle{Lecture\#2, Spring 2026}
...
\href{https://drive.google.com/drive/folders/1jNtoNCL8mLJyda0wu1pLCnjvqIPzd_WL}{\color{blue}{Share Drive}}
    \item Read about \emph{the risk parity strategy} from the files:\\
      \texttt{Asness Leverage Risk Parity.pdf},
      \texttt{Clarke Risk Parity Minimum Variance Portfolios.pdf},
      \texttt{Sorensen Risk Parity Portfolios.pdf}.
    \item Read about \emph{the seasonal anomalies} from the files:\\
      \texttt{Matilde Sell in May Halloween Seasonal Anomaly.pdf},
      \texttt{Afik Sell in May Halloween Seasonal Anomaly.pdf}
      \texttt{Knuteson Overnight Seasonal Anomaly 2021.pdf},
      \texttt{Bogousslavsky Overnight Seasonal Anomaly.pdf},
      \texttt{Lachance Overnight Seasonal Anomaly.pdf}.
    \item Read about \emph{stop loss rules} from the file:
      \texttt{Bailey Prado Stop Loss Rules.pdf}.
    \item Download all the shiny app files named \texttt{app\_*.R} from the 
\href{https://drive.google.com/drive/folders/1jNtoNCL8mLJyda0wu1pLCnjvqIPzd_WL}{\color{blue}{Share Drive}},
      and run them by pressing the "Run App" button in \emph{RStudio}.
    \item Download all the \emph{Rmarkdown} files named \texttt{*.Rmd} from the 
\href{https://drive.google.com/drive/folders/1jNtoNCL8mLJyda0wu1pLCnjvqIPzd_WL}{\color{blue}{Share Drive}},
      and render them into \emph{html} documents by pressing the "knit" button in \emph{RStudio}.
  \end{itemize}
\end{block}
