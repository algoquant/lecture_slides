...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      So that the stock allocations (\emph{dollar amounts}) have equal dollar volatilities.
      \vskip1ex
      The risk parity strategy has a higher Sharpe ratio than the equal dollar portfolio because it's overweight bonds. 
...
dygraphs::dygraph(priceb["2008-09/2009-09"], main="VTI Prices and Bollinger Bands") %>%
  ...
  dySeries(name=colnamev[2], strokeWidth=2, col="purple") %>%
...
dygraphs::dygraph(priceb["2008-09/2009-09"], 
  ...
  dySeries(name=colnamev[1], strokeWidth=2, col="blue") %>%
  dySeries(name=colnamev[2], strokeWidth=2, strokePattern="dashed", col="green") %>%
