...
\begin{block}{Recommended}
  \begin{itemize}[]
    \item Download the files below from the 
\href{https://drive.google.com/drive/folders/1jNtoNCL8mLJyda0wu1pLCnjvqIPzd_WL}{\color{blue}{Share Drive}}
