...
# Source Rcpp functions from file
Rcpp::sourceCpp(file="C:/Develop/lecture_slides/scripts/unifunc.cpp")
...
prices <- mget(c("VTI", "VXX"), envir=rutils::etf_env)
...
library(rutils)
library(ggplot2)
prices <- rutils::etf_env$prices[, 1]
...
all.equal(vtis, rutils::etf_env$VTI)
