...
%%%%%%%%%%%%%%%
\begin{frame}[fragile,t]{Distribution of VTI Returns}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
...
%%%%%%%%%%%%%%%
\begin{frame}[fragile,t]{VTI Quantile-Quantile Plot}
\vspace{-1em}
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The \emph{VTI} Q-Q plot shows that the \emph{VTI} return distribution has fat tails,
      <<echo=TRUE,eval=FALSE>>=
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      ...
      \vskip1ex
      The function \texttt{.index()} extracts the time index expressed in the number of seconds.
      \vskip1ex
