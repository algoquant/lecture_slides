...
textplot(x=car_s[, "hp"], y=car_s[, "mpg"],
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/scatter_plot}\\
...
legend(x="left", legend=c("Height", "Volume"),
      ...
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.45\paperwidth]{figure/line_plot.png}\\
...
legend(x="topright", legend=c("sine", "cosine"),
       title="legend", inset=0.1, cex=1.0, bg="white", y.intersp=0.5, 
       lwd=2, lty=1, bty="n", col=c("red", "blue"))
graphics.off()  # Close all graphics devices
      @
    \column{0.5\textwidth}
    \vspace{-3em}
    \includegraphics[width=0.45\paperwidth]{figure/sincosplot-1}
  \end{columns}
\end{block}
...
legend(x="topright", legend=c("Normal", "shifted"),
       title="legend", inset=0.05, cex=0.8, bg="white", y.intersp=0.5, 
       lwd=2, lty=1, bty="n", col=c("blue", "red"))
      @
    \column{0.5\textwidth}
    \includegraphics[width=0.45\paperwidth]{figure/funplot-1}
  \end{columns}
\end{block}
...
abline(v=a_t, col="grey", lwd=0.5)
    ...
    \column{0.5\textwidth}
    \vspace{-1em}
    \includegraphics[width=0.45\paperwidth]{figure/zoo_plot_axis_dates.png}
    \vspace{-2em}
    <<echo=(-(1:7)),eval=FALSE>>=
library(zoo)  # Load zoo
load(file="/Users/jerzy/Develop/lecture_slides/data/zoo_data.RData")
...
legend("top", legend=colnamev,
  bg="white", lty=1, lwd=6, y.intersp=0.5, 
  col=c("black", "red"), bty="n")
      @
    \column{0.5\textwidth}
    \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/plot_2y.png}
    \vspace{-2em}
...
par(graph_params)  # Restore original parameters
    ...
    \column{0.5\textwidth}
      \vspace{-3em}
      \includegraphics[width=0.45\paperwidth]{figure/par_ams-1}
      \vspace{-3em}
      \begin{itemize}
...
# Add legend
legend("topright", inset=0.05, title="Sigmas", y.intersp=0.5, 
...
legend("topright", inset=0.05, title="Sigmas",
       paste("sigma", sigmavs, sep="="), y.intersp=0.5, 
...
title(main="Chi-squared Distributions", line=0.5)
# Add legend
legend("topright", inset=0.05, y.intersp=0.5, 
       title="Degrees of freedom", labelv,
...
legend("topright", inset=0.05, title="degrees of freedom",
       y.intersp=0.5, labelv, cex=0.8, lwd=2, lty=1, col=colorv)
      @
  \end{columns}
\end{block}
...
legend("topright", inset=0.05, bty="n",
       title="Degrees\n of freedom", labelv,
       y.intersp=0.5, cex=0.8, lwd=6, lty=1, col=colorv)
      @
  \end{columns}
\end{block}
...
# Add legend
legend("topright", inset=0.05, bty="n",
       y.intersp=0.5, title=NULL,leg=c("Normal", "Cauchy"),
...
legend("topright", inset=0.2, bty="n", y.intersp=0.5, 
...
legend("topright", inset=0.01, title="Poisson histogram",
       ...
       y.intersp=0.5, lty=1, bty="n", col=c("blue", "red"))
...
inputPanel(
  sliderInput("lambda", label="lambda:",
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/ewma_shiny.pdf}
      \vspace{-3em}
      <<echo=TRUE,eval=FALSE>>=
renderPlot({
  ...
  ewmacpp <- .Call(stats:::C_cfilter, closep, filter=weights, sides=1, circular=FALSE)
  ...
  legend("top", legend=colnames(ewmacpp),
         y.intersp=0.5, inset=0.1, bg="white", lty=1, lwd=2,
...
my_ggplot  # Render the plot
      ...
      \vspace{-2em}
      \hspace*{-2em}
      \includegraphics[width=0.45\paperwidth]{figure/ggplot_basic1-1}
  \end{columns}
\end{block}
...
grid.arrange(my_ggplot +
  ...
  my_ggplot + ggtitle("directlabels") +
    ...
    \column{0.5\textwidth}
      \vspace{-2em}
      \hspace*{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/ggplot_scatter_lab-1}
  \end{columns}
\end{block}
...
my_ggplot  # Render the plot
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/ggplot_scatter_lab_group-1}
  \end{columns}
\end{block}
...
grid.arrange(ggp.zoo1, ggp.zoo2, ncol=1)
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \hspace*{-1em}
      \includegraphics[width=0.45\paperwidth]{figure/ggplot_zoo2-1}
  \end{columns}
\end{block}
...
persp(z=outer(xlim, ylim, FUN=fun2d),
      ...
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.45\paperwidth]{figure/surf_plot-1}
  \end{columns}
\end{block}
...
rgl::rglwidget(elementId="plot3drgl", width=1000, height=1000)
      @
    \column{0.5\textwidth}
      \includegraphics[width=0.45\paperwidth]{figure/rgl_scatter3d}
  \end{columns}
\end{block}
