...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      Let $Z_1, \ldots , Z_k$ be independent standard normal random variables,
      \vskip1ex
      Let $X = \sum_{i=1}^k Z_i^2$, \hskip1em then $X \sim \chi_k^2$,
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      Let $Z_1, \ldots , Z_k$ be independent standard normal random variables,
      \vskip1ex
      Let $s^2 = \sum_{i=1}^{\nu} Z_i^2$, \hskip1em $t = \frac{\sum_{i=1}^{\nu} Z_i}{s}$,
...
boxplot(formula=mpg ~ cyl, data=mtcars,
    ...
    \column{0.5\textwidth}
      \vspace{-1em}
      \includegraphics[width=0.4\paperwidth,valign=t]{figure/boxplot.png}\\
      \includegraphics[width=0.4\paperwidth,valign=t]{figure/boxplot_poiss.png}
  \end{columns}
\end{block}
...
\begin{block}{}
  \begin{columns}[T]
    \column{0.5\textwidth}
      \emph{rgl} is an \texttt{R} package for creating \emph{interactive 3d graphics}, based on the \emph{OpenGL} framework,
      \vskip1ex
      \emph{rgl} allows creating \emph{interactive} 3d scatterplots and surface plots
