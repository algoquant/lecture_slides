...
\subtitle{Lecture\#1, Spring 2023}
...
The graduate assistant (GA) will be Wenxin Li \href{mailto:wl2570@nyu.edu}{wl2570@nyu.edu}.\\
...
\begin{itemize}[]
  \item \href{https://www.amazon.com/dp/1119482089/}{\emph{Advances in Financial Machine Learning}} by Marcos Lopez de Prado, great overview of machine learning techniques applied to quant trading.
