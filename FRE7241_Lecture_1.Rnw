...
\begin{itemize}
  ...
  \item The portfolios are rebalanced less frequently (monthly, weekly, or daily.)
...
%%%%%%%%%%%%%%%
\subsection{Types of Systematic Strategies}
\begin{frame}[t]{\subsecname}
\vspace{-1em}
\begin{block}{Examples of Systematic Strategies}
\begin{itemize}
  \item \emph{Trend following}: Buy stocks with rising prices and short stocks with falling prices.
  \item \emph{Stock momentum}: Buy stocks with high past returns and short stocks with low returns.
