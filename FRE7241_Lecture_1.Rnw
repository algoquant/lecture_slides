...
The graduate assistant (GA) will be Yichen Wang \href{mailto:yw3071@nyu.edu}{yw3071@nyu.edu}.\\
...
\begin{itemize}[]
  ...
  \emph{"Financial Risk Modelling and Portfolio Optimization with R"}, by Bernhard Pfaff, 2013.
  % \fullcite{pfaffbook}\\
  ...
  \emph{"Statistics and Data Analysis for Financial Engineering"}, by David Ruppert, 2011.
  % \fullcite{ruppertbook}\\
  \item \emph{"Applied Econometrics"} introduces advanced statistical models and econometrics:\\
  \emph{"Applied Econometrics with R"}, by Christian Kleiber and Achim Zeileis, 2008.
...
\begin{block}{}
\begin{itemize}[]
  \item \emph{"The Art of R Programming"} good introduction to \texttt{R} and to statistical models  (you can also download it for free):\\
