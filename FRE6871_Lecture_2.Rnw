...
\begin{block}{Required}
  \begin{itemize}[]
    ...
    \item Run the \emph{shiny} app with the credit portfolio loss distribution model: \emph{app\_credit\_portfolio\_loss.R}.
    \item Download the above files from the 
\href{https://drive.google.com/drive/folders/1abep6n9Jgx4IPhMKXbpYZHAySgLXq1SS}{\color{blue}{Share Drive}}.
  \end{itemize}
\end{block}
